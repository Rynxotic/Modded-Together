ServerEvents.recipes((event) => {
  ...
  event.recipes.ars_nouveau.imbuement(
    ...
    2000,
    ["malum:arcane_spirit", "minecraft:stone_button", "minecraft:clock"],
  );
  event.recipes.ars_nouveau.imbuement(
    ["#c:gems/source"],
    "ars_nouveau:water_essence",
    2000,
    ["malum:aqueous_spirit", "minecraft:water_bucket", "minecraft:seagrass"],
  );
  event.recipes.ars_nouveau.imbuement(
    ["#c:gems/source"],
  ...
  event.recipes.ars_nouveau.imbuement(
    ...
    2000,
    ["malum:earthen_spirit", "#c:ingots/iron", "minecraft:dirt"],
  );
  event.recipes.ars_nouveau.imbuement(
    ["#c:gems/source"],
    "ars_nouveau:air_essence",
    2000,
    ["malum:aerial_spirit", "minecraft:feather", "#minecraft:arrows"],
  );
  event.recipes.ars_nouveau.imbuement(
    ["#c:gems/source"],
  ...
  event.recipes.ars_nouveau.imbuement(
    ...
    3000,
    ["minecraft:nether_star", "malum:arcane_spirit", "malum:eldritch_spirit"],
  );
  event.recipes.ars_nouveau.imbuement(
    ["#c:gems/source"],
